...
def attack0():
    global puissance
    puissance = 20
    print (my_pokemon.pokemon, "utilise", my_pokemon_pouvoirs[0])
    my_pokemon.phase_attaque()
def attack1():
     global puissance
    
     puissance = 40
     print (my_pokemon.pokemon, "utilise", my_pokemon_pouvoirs[1])
     my_pokemon.phase_attaque()
def attack2():
     global puissance
  
     puissance = 90
     print (my_pokemon.pokemon, "utilise", my_pokemon_pouvoirs[2])
     my_pokemon.phase_attaque()
def attack3():
     global puissance
    
     puissance = 120
     print (my_pokemon.pokemon, "utilise", my_pokemon_pouvoirs[3])
     my_pokemon.phase_attaque()
class Combat:
...
class Pokemon(Combat):
     ...
     def phase_attaque(self):
         ...
         if player == 1:
          ...
          player = 2
          contre = random.choice(my_opponent_pouvoirs)
          if contre == "griffe":
              puissance = 20
              my_opponent.pv -= puissance
              print (my_opponent.pokemon, "utilise", my_opponent_pouvoirs[0])
              
          elif contre == "flammèche":
              puissance = 40
              my_opponent.pv -= puissance
              print (my_opponent.pokemon, "utilise", my_opponent_pouvoirs[1])
              
          elif contre == "lance-flammes":
              puissance = 90
              my_opponent.pv -= puissance
              print (my_opponent.pokemon, "utilise", my_opponent_pouvoirs[2])
            
          elif contre == "déflagration":
              puissance = 120
              my_opponent.pv -= puissance
              print (my_opponent.pokemon, "utilise", my_opponent_pouvoirs[3])
...
my_pokemon_pouvoirs = ["charge", "pistolet à o", "surf", "hydrocanon"]
my_opponent_pouvoirs = ["griffe", "flammèche", "lance-flammes", "déflagration"]
